...
# ✅ Use default experiment (safe and auto-created)
with mlflow.start_run(run_name="wine-classification"):
    ...
    # Optional: log the script itself if running as a file
    if '__file__' in globals():
        mlflow.log_artifact(__file__)

    # Tags
    mlflow.set_tags({"Author": 'Aniket', "Project": "Wine Classification"})
